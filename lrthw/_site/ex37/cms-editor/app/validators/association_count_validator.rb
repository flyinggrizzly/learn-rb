# Validate the number of associated nested objects taking into account items marked for destruction
# From http://homeonrails.com/2012/10/associationcountvalidator/
