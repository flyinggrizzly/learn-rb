Rails.application.configure do
  ...
  default_logger = ActiveSupport::Logger.new('log/development.log', 10, 50 * 1024 * 1024)
  ...
  # Set as environment variables for local only
  # For example http://your-hostname.campus.bath.ac.uk:81/ and http://your-hostname.campus.bath.ac.uk/ respectively
  config.x.preview_url = ENV['CMS_PREVIEW_URL']
  config.x.published_url = ENV['CMS_PUBLISHED_URL']
end
