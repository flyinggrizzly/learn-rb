Rails.application.configure do
  ...
  default_logger = ActiveSupport::Logger.new('log/training.log', 10, 50 * 1024 * 1024)
  ...
  config.action_controller.asset_host = 'training-beta.bath.ac.uk'

  # URL prefix for preview and live pages
  config.x.preview_url = 'http://training-preview.bath.ac.uk'
  config.x.published_url = 'http://training-beta.bath.ac.uk'
end
